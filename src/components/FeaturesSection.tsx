        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-primary-light/10 rounded-2xl p-8 lg:p-12 card-soft">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-primary hover:bg-primary-light text-white px-8 py-3 rounded-lg font-semibold transition-smooth hover:scale-105 hero-shadow">
                Start Free Trial
              </button>
              <button className="border border-primary/20 hover:border-primary/40 text-primary px-8 py-3 rounded-lg font-semibold transition-smooth hover:bg-primary/5">
                Schedule Demo
              </button>
            </div>
          </div>
